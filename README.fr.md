...
📖 Pour plus de méthodes de déploiement, veuillez vous référer à [Guide de déploiement](https://token.yishangcloud.cn/docsinstallation)
...
### 📖 [Documentation officielle](https://token.yishangcloud.cn/docs) | [![Demander à DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/new-api)
...
| Catégorie | Lien |
|------|------|
| 🚀 Guide de déploiement | [Documentation d'installation](https://token.yishangcloud.cn/docsinstallation) |
| ⚙️ Configuration de l'environnement | [Variables d'environnement](https://token.yishangcloud.cn/docsinstallation/environment-variables) |
| 📡 Documentation de l'API | [Documentation de l'API](https://token.yishangcloud.cn/docsapi) |
| ❓ FAQ | [FAQ](https://token.yishangcloud.cn/docssupport/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://token.yishangcloud.cn/docssupport/community-interaction) |

---

## ✨ Fonctionnalités clés

> Pour les fonctionnalités détaillées, veuillez vous référer à [Présentation des fonctionnalités](https://token.yishangcloud.cn/docswiki/features-introduction) |
...
- ⚡ [OpenAI Realtime API](https://token.yishangcloud.cn/docsapi/openai-realtime) (y compris Azure)
...
- 🔄 [Modèles Rerank](https://token.yishangcloud.cn/docsapi/jinaai-rerank) (Cohere, Jina)
...
> Pour les détails, veuillez vous référer à [Documentation de l'API - Interface de relais](https://token.yishangcloud.cn/docsapi)
...
| 💬 Claude | Format Messages | [Documentation](https://token.yishangcloud.cn/docsapi/anthropic-chat) |
| 🌐 Gemini | Format Google Gemini | [Documentation](https://token.yishangcloud.cn/docsapi/google-gemini-chat/) |
| 🔧 Dify | Mode ChatFlow | - |
...
- [Interface de discussion (Chat Completions)](https://token.yishangcloud.cn/docsapi/openai-chat)
- [Interface de réponse (Responses)](https://token.yishangcloud.cn/docsapi/openai-responses)
- [Interface d'image (Image)](https://token.yishangcloud.cn/docsapi/openai-image)
- [Interface audio (Audio)](https://token.yishangcloud.cn/docsapi/openai-audio)
- [Interface vidéo (Video)](https://token.yishangcloud.cn/docsapi/openai-video)
- [Interface d'incorporation (Embeddings)](https://token.yishangcloud.cn/docsapi/openai-embeddings)
- [Interface de rerank (Rerank)](https://token.yishangcloud.cn/docsapi/jinaai-rerank)
- [Conversation en temps réel (Realtime)](https://token.yishangcloud.cn/docsapi/openai-realtime)
- [Discussion Claude](https://token.yishangcloud.cn/docsapi/anthropic-chat)
- [Discussion Google Gemini](https://token.yishangcloud.cn/docsapi/google-gemini-chat/)
...
📖 **Configuration complète:** [Documentation des variables d'environnement](https://token.yishangcloud.cn/docsinstallation/environment-variables)
...
| 📘 FAQ | [FAQ](https://token.yishangcloud.cn/docssupport/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://token.yishangcloud.cn/docssupport/community-interaction) |
| 🐛 Commentaires sur les problèmes | [Commentaires sur les problèmes](https://token.yishangcloud.cn/docssupport/feedback-issues) |
| 📚 Documentation complète | [Documentation officielle](https://token.yishangcloud.cn/docssupport) |
...
**[Documentation officielle](https://token.yishangcloud.cn/docs)** • **[Commentaires sur les problèmes](https://github.com/Calcium-Ion/new-api/issues)** • **[Dernière version](https://github.com/Calcium-Ion/new-api/releases)**
